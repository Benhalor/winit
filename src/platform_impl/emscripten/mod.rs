...
impl Window {
        ...
        -> Result<Window, OsError>
    {
        if events_loop.window.lock().unwrap().is_some() {
            return Err(OsError("Cannot create another window".to_owned()));
        }
    ...
    #[inline]
    pub fn get_inner_position(&self) -> Option<Position> {
        Some((0, 0).into())
    }

    #[inline]
    pub fn set_position(&self, _: Position) {
    }

    #[inline]
    pub fn get_inner_size(&self) -> Option<Size> {
        unsafe {
            let mut width = 0;
            let mut height = 0;
    ...
    #[inline]
    pub fn get_outer_size(&self) -> Option<Size> {
        self.get_inner_size()
    }
    ...
    #[inline]
    pub fn set_min_dimensions(&self, _dimensions: Option<Size>) {
        // N/A
    }

    #[inline]
    pub fn set_max_dimensions(&self, _dimensions: Option<Size>) {
        // N/A
    }
    ...
    #[inline]
    pub fn set_cursor(&self, _cursor: CursorIcon) {
        // N/A
    }
    ...
    #[inline]
    pub fn set_cursor_position(&self, _position: Position) -> Result<(), String> {
    ...
    #[inline]
    pub fn set_ime_spot(&self, _logical_spot: Position) {
        // N/A
    }
